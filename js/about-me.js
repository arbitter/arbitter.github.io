...
function gdMouseOver() {
  gameDev.innerHTML = "<dl>" +
                        "<dt><h4>UE4</h4></dt>" +
                        "<dt><h4>UMG</h4></dt>" +
                        "<dt><h4>Blueprint</h4></dt>" +
                        "<dt><h4>Unity</h4></dt>" +
                        "<dt><h4>Box2D</h4></dt>" +
                      "</dl>";
}
...
function stMouseOver() {
  softwareTest.innerHTML = "<dl>" +
                              "<dt><h4>Unit Testing</h4></dt>" +
                              "<dt><h4>Branch Testing</h4></dt>" +
                              "<dt><h4>Testing Automation</h4></dt>" +
                              "<dt><h4>Appium</h4></dt>" +
                              "<dt><h4>Selenium</h4></dt>" +
                            "</dl>";
}

function uxMouseOver() {
  userEx.innerHTML = "<dl>" +
                        "<dt><h4>User Stories</h4></dt>" +
                        "<dt><h4>Use Cases</h4></dt>" +
                        "<dt><h4>Wireframing</h4></dt>" +
                        "<dt><h4>Information Architecture</h4></dt>" +
                      "</dl>";
}

function ssMouseOver() {
  softSkills.innerHTML = "<dl>" +
                            "<dt><h4>Communication</h4></dt>" +
                            "<dt><h4>Collaboration</h4></dt>" +
                            "<dt><h4>Critical Thinking</h4></dt>" +
                            "<dt><h4>Work Ethic</h4></dt>" +
                          "</dl>";
}

function dtMouseOver(){
  console.log("Dev Tools Mouse Over Logged");
  devTools.innerHTML = "<dl>" +
                          "<dt><h4>GitHub</h4></dt>" +
                          "<dt><h4>Subversion</h4></dt>" +
                          "<dt><h4>Trello</h4></dt>" +
                        "</dl>";
}
